...
class AppointmentState {
  ...
  const AppointmentState.initial()
    : this(appointments: const [], isLoading: false, isCreating: false);

  const AppointmentState.loading()
    : this(appointments: const [], isLoading: true, isCreating: false);

  const AppointmentState.creating()
    : this(appointments: const [], isLoading: false, isCreating: true);
  ...
  AppointmentState.success({required List<AppointmentModel> appointments})
    : this(appointments: appointments, isLoading: false, isCreating: false);
  ...
  AppointmentState copyWith({
    ...
    return AppointmentState(
      ...
      cancelledAppointmentId:
          cancelledAppointmentId ?? this.cancelledAppointmentId,
